...
from Updates import HBUpdates, status_plaatjes, skip_reminder
from Updates import ScanUpdates
from utils import logger, one_of_in, get_deelgebied
import telegram
import threading
import time
        ...
        if 'aan' in command and 'uit' in command:
            ...
            if len(command) == 3:
                if get_deelgebied(command[2]) is not None:
                    ...
                    if command[1] == utils.get_deelgebied('HB'):
